...
* [bpmn-js-examples](https://github.com/bpmn-io/bpmn-js-examples) ⭐ 2,043 | 🐛 9 | 🌐 JavaScript | 📅 2026-08-19 - Large list of bpmn-js usage examples
* [dmn-js-examples](https://github.com/bpmn-io/dmn-js-examples) ⭐ 38 | 🐛 2 | 🌐 HTML | 📅 2026-07-29 - Set of dmn-js usage examples
* [form-js-examples](https://github.com/bpmn-io/form-js-examples) ⭐ 32 | 🐛 7 | 🌐 JavaScript | 📅 2026-08-17 - A collection of form-js examples
...
* [bpmn-js](https://github.com/bpmn-io/bpmn-js) ⭐ 9,634 | 🐛 131 | 🌐 JavaScript | 📅 2026-08-19 - BPMN 2.0 process and collaboration diagram renderer/editor
* [form-js](https://github.com/bpmn-io/form-js) ⭐ 548 | 🐛 176 | 🌐 JavaScript | 📅 2026-08-18 - View and visually edit JSON-based forms
* [dmn-js](https://github.com/bpmn-io/dmn-js) ⭐ 364 | 🐛 62 | 🌐 JavaScript | 📅 2026-08-18 - DMN DRD, decision table and literal expression renderer/editor
...
* [diagram-js](https://github.com/bpmn-io/diagram-js) ⭐ 1,916 | 🐛 31 | 🌐 JavaScript | 📅 2026-08-18 - A toolbox for displaying and modifying diagrams on the web
...
#### [diagram-js](https://github.com/bpmn-io/diagram-js) ⭐ 1,916 | 🐛 31 | 🌐 JavaScript | 📅 2026-08-18

* [diagram-js-minimap](https://github.com/bpmn-io/diagram-js-minimap) ⭐ 37 | 🐛 1 | 🌐 JavaScript | 📅 2026-08-18 - Render a minimap of your diagram
...
* [diagram-js-grid](https://github.com/bpmn-io/diagram-js-grid) ⭐ 12 | 🐛 2 | 🌐 JavaScript | 📅 2026-07-24 - A visual grid for diagram-js
* [diagram-js-origin](https://github.com/bpmn-io/diagram-js-origin) ⭐ 9 | 🐛 0 | 🌐 JavaScript | 📅 2024-11-06 - Render a canvas origin cross

#### [bpmn-js](https://github.com/bpmn-io/bpmn-js) ⭐ 9,634 | 🐛 131 | 🌐 JavaScript | 📅 2026-08-19

* [bpmn-js-token-simulation](https://github.com/bpmn-io/bpmn-js-token-simulation) ⭐ 313 | 🐛 21 | 🌐 JavaScript | 📅 2026-07-24 - Simulate tokens running through your process
* [bpmn-js-nyan](https://github.com/bpmn-io/bpmn-js-nyan) ⭐ 103 | 🐛 1 | 🌐 JavaScript | 📅 2026-07-24 - An extension that adds custom resize rules, theming and colors
* [bpmn-js-cli](https://github.com/bpmn-io/bpmn-js-cli) ⭐ 59 | 🐛 2 | 🌐 JavaScript | 📅 2026-07-24 - Model diagrams without the mouse
* [bpmn-js-color-picker](https://github.com/bpmn-io/bpmn-js-color-picker) ⭐ 33 | 🐛 1 | 🌐 JavaScript | 📅 2026-08-18 - Color your BPMN elements via the context pad
* [bpmn-js-sketchy](https://github.com/bpmn-io/bpmn-js-sketchy) ⭐ 31 | 🐛 0 | 🌐 JavaScript | 📅 2026-06-17 - A sketchy renderer for BPMN diagrams
* [bpmn-js-embedded-comments](https://github.com/bpmn-io/bpmn-js-embedded-comments) ⭐ 18 | 🐛 1 | 🌐 JavaScript | 📅 2026-06-17 - Add, edit, and persist comments on BPMN diagrams
* [camunda-transaction-boundaries](https://github.com/bpmn-io/camunda-transaction-boundaries) ⭐ 18 | 🐛 2 | 🌐 JavaScript | 📅 2022-09-08 - Visualize transaction boundaries, applied by the [Camunda workflow engine](https://camunda.com/)
* [bpmn-js-create-append-anything](https://github.com/bpmn-io/bpmn-js-create-append-anything) ⭐ 16 | 🐛 4 | 🌐 JavaScript | 📅 2026-07-24 - Extends bpmn-js with a create and append anything modeling experience.
...
* [bpmn-js-native-copy-paste](https://github.com/nikku/bpmn-js-native-copy-paste) ⭐ 9 | 🐛 0 | 🌐 JavaScript | 📅 2026-02-05 - Copy and paste across [bpmn-js](https://github.com/bpmn-io/bpmn-js) ⭐ 9,634 | 🐛 131 | 🌐 JavaScript | 📅 2026-08-19 instances, browser tabs and applications - using the system clipboard
...
#### [dmn-js](https://github.com/bpmn-io/dmn-js) ⭐ 364 | 🐛 62 | 🌐 JavaScript | 📅 2026-08-18
...
* [dmn-js-simulation](https://github.com/emaarco/dmn-simulation) ⭐ 1 | 🐛 1 | 🌐 TypeScript | 📅 2026-08-17 - Simulate DMN decision tables and DRDs inside a [dmn-js](https://github.com/bpmn-io/dmn-js) ⭐ 364 | 🐛 62 | 🌐 JavaScript | 📅 2026-08-18 modeler

#### Misc

* [bpmnlint](https://github.com/bpmn-io/bpmnlint) ⭐ 169 | 🐛 18 | 🌐 JavaScript | 📅 2026-08-19 - An extensible and configurable BPMN 2.0 diagram validator
* [bpmn-font](https://github.com/bpmn-io/bpmn-font) ⭐ 127 | 🐛 2 | 📅 2026-07-28 - A BPMN 2.0 icon font
...
* [bpmn-js-headless](https://github.com/bpmn-io/bpmn-js-headless) ⭐ 3 | 🐛 0 | 🌐 JavaScript | 📅 2026-07-28 - Execute [bpmn-js](https://github.com/bpmn-io/bpmn-js) ⭐ 9,634 | 🐛 131 | 🌐 JavaScript | 📅 2026-08-19 in headless environments
...
* [react-bpmn](https://github.com/bpmn-io/react-bpmn) ⭐ 220 | 🐛 1 | 🌐 HTML | 📅 2026-08-19 - Render BPMN 2.0 diagrams in a [React](https://reactjs.org/) application
* [bpmn-js-example-angular](https://github.com/bpmn-io/bpmn-js-example-angular) ⭐ 64 | 🐛 1 | 🌐 TypeScript | 📅 2026-07-27 - An integration of bpmn-js with [Angular](https://angular.io/)
...
* [slidev-addon-bpmn](https://github.com/emaarco/slidev-addon-bpmn) ⭐ 7 | 🐛 2 | 🌐 TypeScript | 📅 2026-08-19 - Display BPMN 2.0 diagrams in [Slidev](https://sli.dev) presentations.
* [slidev-addon-dmn](https://github.com/emaarco/slidev-addon-dmn) ⭐ 1 | 🐛 0 | 🌐 Vue | 📅 2026-08-18 - Display DMN diagrams in [Slidev](https://sli.dev) presentations.
...
* [Camunda Desktop Modeler](https://github.com/camunda/camunda-modeler) ⭐ 1,697 | 🐛 626 | 🌐 JavaScript | 📅 2026-08-19 - Implementation tool for [Camunda](https://camunda.com/) and an integrated modeling solution for BPMN, DMN, and Forms.
...
* [Miragon BPMN Modeler](https://github.com/Miragon/bpmn-modeler) ⭐ 33 | 🐛 24 | 🌐 TypeScript | 📅 2026-08-19 - BPMN and DMN modeler shipping as a VS Code extension and standalone desktop app; supports Camunda 7, Camunda 8, Operaton, and CIB seven.
...
* [Making of token simulation](https://github.com/nikku/2021-token-simulation) ⭐ 3 | 🐛 0 | 🌐 HTML | 📅 2021-05-03 - A dive into bpmn-js extensibility and the inner workings of [bpmn-js-token-simulation](https://github.com/bpmn-io/bpmn-js-token-simulation) ⭐ 313 | 🐛 21 | 🌐 JavaScript | 📅 2026-07-24
* [Taking Templates to the limit](https://github.com/pinussilvestrus/ccs2022-resources) ⭐ 2 | 🐛 0 | 📅 2022-05-03 - A hands-on demo on how to create [Element Templates](https://docs.camunda.io/docs/components/modeler/desktop-modeler/element-templates/about-templates/) in your favorite IDE with [JSON Schema](https://github.com/camunda/element-templates-json-schema) ⭐ 9 | 🐛 10 | 🌐 JavaScript | 📅 2026-08-18

## Contribute

Would you like to contribute to this list? [Propose your addition](https://github.com/bpmn-io/awesome-bpmn-io/edit/main/README.md) ⭐ 226 | 🐛 0 | 📅 2026-08-13.
