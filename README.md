...
* [form-js-examples](https://github.com/bpmn-io/form-js-examples) ⭐ 32 | 🐛 7 | 🌐 JavaScript | 📅 2026-09-25 - A collection of form-js examples
...
#### [bpmn-js](https://github.com/bpmn-io/bpmn-js) ⭐ 9,668 | 🐛 126 | 🌐 JavaScript | 📅 2026-09-25
...
* [bpmn-js-native-copy-paste](https://github.com/nikku/bpmn-js-native-copy-paste) ⭐ 9 | 🐛 0 | 🌐 JavaScript | 📅 2026-02-05 - Copy and paste across [bpmn-js](https://github.com/bpmn-io/bpmn-js) ⭐ 9,668 | 🐛 126 | 🌐 JavaScript | 📅 2026-09-25 instances, browser tabs and applications - using the system clipboard
...
#### [dmn-js](https://github.com/bpmn-io/dmn-js) ⭐ 366 | 🐛 69 | 🌐 JavaScript | 📅 2026-09-25
...
* [dmn-js-simulation](https://github.com/emaarco/dmn-simulation) ⭐ 1 | 🐛 0 | 🌐 TypeScript | 📅 2026-09-21 - Simulate DMN decision tables and DRDs inside a [dmn-js](https://github.com/bpmn-io/dmn-js) ⭐ 366 | 🐛 69 | 🌐 JavaScript | 📅 2026-09-25 modeler
...
* [bpmn-js-headless](https://github.com/bpmn-io/bpmn-js-headless) ⭐ 3 | 🐛 0 | 🌐 JavaScript | 📅 2026-08-28 - Execute [bpmn-js](https://github.com/bpmn-io/bpmn-js) ⭐ 9,668 | 🐛 126 | 🌐 JavaScript | 📅 2026-09-25 in headless environments
...
* [react-bpmn](https://github.com/bpmn-io/react-bpmn) ⭐ 223 | 🐛 0 | 🌐 HTML | 📅 2026-09-25 - Render BPMN 2.0 diagrams in a [React](https://reactjs.org/) application
...
* [Camunda Desktop Modeler](https://github.com/camunda/camunda-modeler) ⭐ 1,715 | 🐛 627 | 🌐 JavaScript | 📅 2026-09-25 - Implementation tool for [Camunda](https://camunda.com/) and an integrated modeling solution for BPMN, DMN, and Forms.
* [bpmn-io-vs-code](https://github.com/bpmn-io/vs-code-bpmn-io) ⭐ 135 | 🐛 9 | 🌐 TypeScript | 📅 2026-09-24 - Display and edit BPMN diagrams in VS Code using bpmn.io tools
* [postit-js](https://github.com/pinussilvestrus/postit-js) ⭐ 97 | 🐛 19 | 🌐 JavaScript | 📅 2026-09-24 - Create Post-it boards on a canvas editor
...
* [Miragon BPMN Modeler](https://github.com/Miragon/bpmn-modeler) ⭐ 35 | 🐛 42 | 🌐 TypeScript | 📅 2026-09-24 - BPMN and DMN modeler shipping as a VS Code extension and standalone desktop app; supports Camunda 7, Camunda 8, Operaton, and CIB seven.
