...
* [bpmn-js-examples](https://github.com/bpmn-io/bpmn-js-examples) ⭐ 2,042 | 🐛 8 | 🌐 JavaScript | 📅 2026-08-28 - Large list of bpmn-js usage examples
...
* [bpmn-js](https://github.com/bpmn-io/bpmn-js) ⭐ 9,642 | 🐛 129 | 🌐 JavaScript | 📅 2026-08-28 - BPMN 2.0 process and collaboration diagram renderer/editor
...
#### [bpmn-js](https://github.com/bpmn-io/bpmn-js) ⭐ 9,642 | 🐛 129 | 🌐 JavaScript | 📅 2026-08-28
...
* [bpmn-js-native-copy-paste](https://github.com/nikku/bpmn-js-native-copy-paste) ⭐ 9 | 🐛 0 | 🌐 JavaScript | 📅 2026-02-05 - Copy and paste across [bpmn-js](https://github.com/bpmn-io/bpmn-js) ⭐ 9,642 | 🐛 129 | 🌐 JavaScript | 📅 2026-08-28 instances, browser tabs and applications - using the system clipboard
...
* [bpmn-js-differ](https://github.com/bpmn-io/bpmn-js-differ) ⭐ 54 | 🐛 7 | 🌐 JavaScript | 📅 2026-08-28 - A semantic diff tool for BPMN diagrams
...
* [bpmn-js-headless](https://github.com/bpmn-io/bpmn-js-headless) ⭐ 3 | 🐛 0 | 🌐 JavaScript | 📅 2026-08-28 - Execute [bpmn-js](https://github.com/bpmn-io/bpmn-js) ⭐ 9,642 | 🐛 129 | 🌐 JavaScript | 📅 2026-08-28 in headless environments
...
* [react-bpmn](https://github.com/bpmn-io/react-bpmn) ⭐ 222 | 🐛 0 | 🌐 HTML | 📅 2026-08-28 - Render BPMN 2.0 diagrams in a [React](https://reactjs.org/) application
...
* [Camunda Desktop Modeler](https://github.com/camunda/camunda-modeler) ⭐ 1,702 | 🐛 625 | 🌐 JavaScript | 📅 2026-08-28 - Implementation tool for [Camunda](https://camunda.com/) and an integrated modeling solution for BPMN, DMN, and Forms.
...
* [Miragon BPMN Modeler](https://github.com/Miragon/bpmn-modeler) ⭐ 35 | 🐛 30 | 🌐 TypeScript | 📅 2026-08-30 - BPMN and DMN modeler shipping as a VS Code extension and standalone desktop app; supports Camunda 7, Camunda 8, Operaton, and CIB seven.
