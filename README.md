...
* [bpmn-js-examples](https://github.com/bpmn-io/bpmn-js-examples) ⭐ 2,047 | 🐛 8 | 🌐 JavaScript | 📅 2026-09-23 - Large list of bpmn-js usage examples
* [dmn-js-examples](https://github.com/bpmn-io/dmn-js-examples) ⭐ 38 | 🐛 2 | 🌐 HTML | 📅 2026-09-23 - Set of dmn-js usage examples
* [form-js-examples](https://github.com/bpmn-io/form-js-examples) ⭐ 32 | 🐛 7 | 🌐 JavaScript | 📅 2026-09-18 - A collection of form-js examples
...
* [bpmn-js](https://github.com/bpmn-io/bpmn-js) ⭐ 9,665 | 🐛 126 | 🌐 JavaScript | 📅 2026-09-23 - BPMN 2.0 process and collaboration diagram renderer/editor
* [form-js](https://github.com/bpmn-io/form-js) ⭐ 551 | 🐛 172 | 🌐 JavaScript | 📅 2026-09-23 - View and visually edit JSON-based forms
* [dmn-js](https://github.com/bpmn-io/dmn-js) ⭐ 366 | 🐛 73 | 🌐 JavaScript | 📅 2026-09-23 - DMN DRD, decision table and literal expression renderer/editor
...
* [diagram-js](https://github.com/bpmn-io/diagram-js) ⭐ 1,926 | 🐛 31 | 🌐 JavaScript | 📅 2026-09-23 - A toolbox for displaying and modifying diagrams on the web
...
#### [diagram-js](https://github.com/bpmn-io/diagram-js) ⭐ 1,926 | 🐛 31 | 🌐 JavaScript | 📅 2026-09-23

* [diagram-js-minimap](https://github.com/bpmn-io/diagram-js-minimap) ⭐ 37 | 🐛 0 | 🌐 JavaScript | 📅 2026-09-23 - Render a minimap of your diagram
...
#### [bpmn-js](https://github.com/bpmn-io/bpmn-js) ⭐ 9,665 | 🐛 126 | 🌐 JavaScript | 📅 2026-09-23

* [bpmn-js-token-simulation](https://github.com/bpmn-io/bpmn-js-token-simulation) ⭐ 318 | 🐛 21 | 🌐 JavaScript | 📅 2026-09-23 - Simulate tokens running through your process
...
* [bpmn-js-color-picker](https://github.com/bpmn-io/bpmn-js-color-picker) ⭐ 34 | 🐛 0 | 🌐 JavaScript | 📅 2026-09-20 - Color your BPMN elements via the context pad
...
* [bpmn-js-native-copy-paste](https://github.com/nikku/bpmn-js-native-copy-paste) ⭐ 9 | 🐛 0 | 🌐 JavaScript | 📅 2026-02-05 - Copy and paste across [bpmn-js](https://github.com/bpmn-io/bpmn-js) ⭐ 9,665 | 🐛 126 | 🌐 JavaScript | 📅 2026-09-23 instances, browser tabs and applications - using the system clipboard
...
#### [dmn-js](https://github.com/bpmn-io/dmn-js) ⭐ 366 | 🐛 73 | 🌐 JavaScript | 📅 2026-09-23
...
* [dmn-js-simulation](https://github.com/emaarco/dmn-simulation) ⭐ 1 | 🐛 0 | 🌐 TypeScript | 📅 2026-09-21 - Simulate DMN decision tables and DRDs inside a [dmn-js](https://github.com/bpmn-io/dmn-js) ⭐ 366 | 🐛 73 | 🌐 JavaScript | 📅 2026-09-23 modeler

#### Misc

* [bpmnlint](https://github.com/bpmn-io/bpmnlint) ⭐ 171 | 🐛 14 | 🌐 JavaScript | 📅 2026-09-09 - An extensible and configurable BPMN 2.0 diagram validator
* [bpmn-font](https://github.com/bpmn-io/bpmn-font) ⭐ 128 | 🐛 2 | 📅 2026-08-28 - A BPMN 2.0 icon font
* [bpmn-to-image](https://github.com/bpmn-io/bpmn-to-image) ⭐ 77 | 🐛 5 | 🌐 JavaScript | 📅 2026-09-10 - Transform BPMN diagrams to images from the command line
...
* [bpmn-js-headless](https://github.com/bpmn-io/bpmn-js-headless) ⭐ 3 | 🐛 0 | 🌐 JavaScript | 📅 2026-08-28 - Execute [bpmn-js](https://github.com/bpmn-io/bpmn-js) ⭐ 9,665 | 🐛 126 | 🌐 JavaScript | 📅 2026-09-23 in headless environments
...
* [react-bpmn](https://github.com/bpmn-io/react-bpmn) ⭐ 223 | 🐛 0 | 🌐 HTML | 📅 2026-09-23 - Render BPMN 2.0 diagrams in a [React](https://reactjs.org/) application
...
* [slidev-addon-bpmn](https://github.com/emaarco/slidev-addon-bpmn) ⭐ 9 | 🐛 2 | 🌐 TypeScript | 📅 2026-09-23 - Display BPMN 2.0 diagrams in [Slidev](https://sli.dev) presentations.
* [slidev-addon-dmn](https://github.com/emaarco/slidev-addon-dmn) ⭐ 1 | 🐛 0 | 🌐 Vue | 📅 2026-09-23 - Display DMN diagrams in [Slidev](https://sli.dev) presentations.
...
* [Camunda Desktop Modeler](https://github.com/camunda/camunda-modeler) ⭐ 1,715 | 🐛 625 | 🌐 JavaScript | 📅 2026-09-23 - Implementation tool for [Camunda](https://camunda.com/) and an integrated modeling solution for BPMN, DMN, and Forms.
* [bpmn-io-vs-code](https://github.com/bpmn-io/vs-code-bpmn-io) ⭐ 135 | 🐛 9 | 🌐 TypeScript | 📅 2026-09-22 - Display and edit BPMN diagrams in VS Code using bpmn.io tools
...
* [Miragon BPMN Modeler](https://github.com/Miragon/bpmn-modeler) ⭐ 35 | 🐛 30 | 🌐 TypeScript | 📅 2026-09-23 - BPMN and DMN modeler shipping as a VS Code extension and standalone desktop app; supports Camunda 7, Camunda 8, Operaton, and CIB seven.
...
* [Making of token simulation](https://github.com/nikku/2021-token-simulation) ⭐ 3 | 🐛 0 | 🌐 HTML | 📅 2021-05-03 - A dive into bpmn-js extensibility and the inner workings of [bpmn-js-token-simulation](https://github.com/bpmn-io/bpmn-js-token-simulation) ⭐ 318 | 🐛 21 | 🌐 JavaScript | 📅 2026-09-23
* [Taking Templates to the limit](https://github.com/pinussilvestrus/ccs2022-resources) ⭐ 2 | 🐛 0 | 📅 2022-05-03 - A hands-on demo on how to create [Element Templates](https://docs.camunda.io/docs/components/modeler/desktop-modeler/element-templates/about-templates/) in your favorite IDE with [JSON Schema](https://github.com/camunda/element-templates-json-schema) ⭐ 9 | 🐛 10 | 🌐 JavaScript | 📅 2026-09-21
