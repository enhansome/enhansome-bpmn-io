...
* [bpmn-js](https://github.com/bpmn-io/bpmn-js) ⭐ 9,636 | 🐛 131 | 🌐 JavaScript | 📅 2026-08-25 - BPMN 2.0 process and collaboration diagram renderer/editor
* [form-js](https://github.com/bpmn-io/form-js) ⭐ 548 | 🐛 174 | 🌐 JavaScript | 📅 2026-08-25 - View and visually edit JSON-based forms
* [dmn-js](https://github.com/bpmn-io/dmn-js) ⭐ 365 | 🐛 66 | 🌐 JavaScript | 📅 2026-08-25 - DMN DRD, decision table and literal expression renderer/editor
...
* [diagram-js](https://github.com/bpmn-io/diagram-js) ⭐ 1,917 | 🐛 31 | 🌐 JavaScript | 📅 2026-08-18 - A toolbox for displaying and modifying diagrams on the web
* [bpmn-moddle](https://github.com/bpmn-io/bpmn-moddle) ⭐ 510 | 🐛 3 | 🌐 JavaScript | 📅 2026-08-25 - Read, modify and write BPMN 2.0 diagrams from JavaScript
* [dmn-moddle](https://github.com/bpmn-io/dmn-moddle) ⭐ 14 | 🐛 3 | 🌐 JavaScript | 📅 2026-08-25 - Read, modify and write DMN 1.3 diagrams from JavaScript

## Extensions

#### [diagram-js](https://github.com/bpmn-io/diagram-js) ⭐ 1,917 | 🐛 31 | 🌐 JavaScript | 📅 2026-08-18
...
#### [bpmn-js](https://github.com/bpmn-io/bpmn-js) ⭐ 9,636 | 🐛 131 | 🌐 JavaScript | 📅 2026-08-25
...
* [bpmn-js-cli](https://github.com/bpmn-io/bpmn-js-cli) ⭐ 58 | 🐛 2 | 🌐 JavaScript | 📅 2026-07-24 - Model diagrams without the mouse
...
* [bpmn-js-native-copy-paste](https://github.com/nikku/bpmn-js-native-copy-paste) ⭐ 9 | 🐛 0 | 🌐 JavaScript | 📅 2026-02-05 - Copy and paste across [bpmn-js](https://github.com/bpmn-io/bpmn-js) ⭐ 9,636 | 🐛 131 | 🌐 JavaScript | 📅 2026-08-25 instances, browser tabs and applications - using the system clipboard
...
#### [dmn-js](https://github.com/bpmn-io/dmn-js) ⭐ 365 | 🐛 66 | 🌐 JavaScript | 📅 2026-08-25
...
* [dmn-js-simulation](https://github.com/emaarco/dmn-simulation) ⭐ 1 | 🐛 2 | 🌐 TypeScript | 📅 2026-08-24 - Simulate DMN decision tables and DRDs inside a [dmn-js](https://github.com/bpmn-io/dmn-js) ⭐ 365 | 🐛 66 | 🌐 JavaScript | 📅 2026-08-25 modeler
...
* [bpmn-js-differ](https://github.com/bpmn-io/bpmn-js-differ) ⭐ 54 | 🐛 7 | 🌐 JavaScript | 📅 2026-07-18 - A semantic diff tool for BPMN diagrams
...
* [bpmn-js-headless](https://github.com/bpmn-io/bpmn-js-headless) ⭐ 3 | 🐛 0 | 🌐 JavaScript | 📅 2026-07-28 - Execute [bpmn-js](https://github.com/bpmn-io/bpmn-js) ⭐ 9,636 | 🐛 131 | 🌐 JavaScript | 📅 2026-08-25 in headless environments
...
* [react-bpmn](https://github.com/bpmn-io/react-bpmn) ⭐ 221 | 🐛 1 | 🌐 HTML | 📅 2026-08-25 - Render BPMN 2.0 diagrams in a [React](https://reactjs.org/) application
...
* [Camunda Desktop Modeler](https://github.com/camunda/camunda-modeler) ⭐ 1,700 | 🐛 630 | 🌐 JavaScript | 📅 2026-08-25 - Implementation tool for [Camunda](https://camunda.com/) and an integrated modeling solution for BPMN, DMN, and Forms.
...
* [Miragon BPMN Modeler](https://github.com/Miragon/bpmn-modeler) ⭐ 35 | 🐛 27 | 🌐 TypeScript | 📅 2026-08-25 - BPMN and DMN modeler shipping as a VS Code extension and standalone desktop app; supports Camunda 7, Camunda 8, Operaton, and CIB seven.
